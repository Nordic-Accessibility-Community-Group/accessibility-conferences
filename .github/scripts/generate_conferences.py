  ...
  <style>
    ...
    * {{ box-sizing: border-box; }}
    ...
    @media (prefers-color-scheme: dark) {{
      ...
      main {{ padding-block: clamp(2.5rem, 5vw, 4.5rem); }}
      ...
      .intro {{ max-width: 42rem; margin-block: 1.5rem 2.5rem; font-size: 1.2rem; line-height: 1.55; }}
      section {{ margin-block: clamp(2.5rem, 5vw, 4rem); }}
